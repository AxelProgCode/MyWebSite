// ── CONFIG ────────────────────────────────────────────────
// Incolla qui l'URL della tua Google Apps Script Web App
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbz0z4hF5RMS9fefJ1YYliwHjLwwMsovLHAqKvcmxZt9MJ0ft_zF0pV31kk7H7G6lXYuBA/exec';
...
async function api(data) {
  // Apps Script non accetta POST con Content-Type JSON da browser (blocco CORS preflight).
  // Si passa il payload come parametro GET → nessun preflight, risposta JSON normale.
  const url = APPS_SCRIPT_URL + '?payload=' + encodeURIComponent(JSON.stringify(data));
